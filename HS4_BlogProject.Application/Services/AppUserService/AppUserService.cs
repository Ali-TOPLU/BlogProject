...
namespace HS4_BlogProject.Application.Services.AppUserService
{
    public class AppUserService : IAppUserService
    {
        ...
        {
            // Update işlemlerinde, önce id ile ilgili nesneyi ram'e çekerim. Dışarıdan gelen güncel bilgilerle değişiklikleri yaparım. en son SaveChanges ile veritabanına güncellemeleri gönderiririm.
